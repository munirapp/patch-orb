...
import { useAddMenuMutation } from "@/lib/features/menus/menuApi";
...
export default function AddMenuPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    insertData.append("stock", formData.stock);
    insertData.append("price", formData.price);
    insertData.append("image", imageFile);

    addMenu(insertData)
      .catch((error) => {
        console.error(error);
        setAlertMessage("failed add menu, please try again later");
        setAlertStatus("error");
      })
      .then(async (res) => {
        if (res?.error) {
        ...
        setAlertMessage("success add menu");
